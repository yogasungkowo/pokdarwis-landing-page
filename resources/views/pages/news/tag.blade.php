<x-layouts.app :title="'Tag: ' . $tag->name . ' - Pokdarwis'">
    ...
    {{-- Header Section --}}
    <section class="relative py-20 bg-gradient-to-br from-green-50 to-white dark:from-green-900/20 dark:to-slate-900 overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-green-500/5 to-transparent dark:from-green-400/10"></div>
        <div class="absolute top-10 right-10 w-64 h-64 bg-green-100 dark:bg-green-400/20 rounded-full blur-3xl opacity-30"></div>
        <div class="absolute bottom-10 left-10 w-80 h-80 bg-green-200 dark:bg-green-500/20 rounded-full blur-3xl opacity-20"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <nav class="mb-8" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-2 text-sm">
                    <li>
                        <a href="{{ route('home') }}" class="text-slate-500 dark:text-slate-400 hover:text-green-600 dark:hover:text-green-400 transition-colors">
                    ...
                    <li>
                        <a href="{{ route('news') }}" class="text-slate-500 dark:text-slate-400 hover:text-green-600 dark:hover:text-green-400 transition-colors">Berita</a>
                    </li>
                    <li>
                        <svg class="w-4 h-4 text-slate-400 dark:text-slate-500" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
            ...
            <div class="text-center">
                ...
                <div class="inline-flex items-center gap-2 px-6 py-3 rounded-full font-medium mb-6 transition-all duration-300 
                           bg-gradient-to-br from-green-100 to-green-200 dark:from-green-800/30 dark:to-green-700/30
                           border-2 border-green-300 dark:border-green-600
                           text-green-700 dark:text-green-300
                           shadow-lg dark:shadow-2xl dark:shadow-green-500/20">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-12">
                <div class="flex items-center gap-4">
                    ...
                    <select class="border border-slate-300 dark:border-slate-600 rounded-lg px-4 py-2 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    ...
                    @foreach($articles as $article)
                        <article class="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group border border-slate-100 dark:border-slate-700">
                            ...
                            <div class="p-6">
                                ...
                                <h3 class="text-xl font-bold text-slate-800 dark:text-white mb-3 leading-tight group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors">
                                ...
                                <div class="flex items-center justify-between">
                                    <a href="{{ route('news.detail', $article->slug) }}" 
                                       class="text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 font-semibold inline-flex items-center gap-2 group-hover:gap-3 transition-all">
                                        Baca Selengkapnya 
            ...
            @else
                ...
                <div class="text-center py-16">
                    ...
                    <a href="{{ route('news') }}" 
                       class="inline-flex items-center gap-2 px-6 py-3 bg-green-600 dark:bg-green-500 text-white rounded-lg hover:bg-green-700 dark:hover:bg-green-600 transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
