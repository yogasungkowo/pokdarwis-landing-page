        ...
        <div class="text-center">
            <div class="bg-white dark:bg-slate-800 rounded-2xl p-8 lg:p-12 shadow-lg">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="{{ asset('Documents/panduan_malaria.pdf') }}" target="_blank" class="inline-flex items-center justify-center px-8 py-4 bg-transparent border-2 border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 font-semibold rounded-xl transition-colors duration-200">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
